...
%\underline{\textbf{Presentation:}} \href{https://github.com/bizzare-hub/Chest-Xray-alignment-using-STN/blob/main/Spatial_Transformer_Network_for_chest_X-ray_images_preprocessing_mod.pdf}{presentation link}
